			...
			<div class="cont_box write">
				<div class="approval-wrap write">
						...
						<tbody>
							<tr>
								...
								<td><select name="approval_category_no"
									...
									<input type="hidden" id="prevApprovalFormNo" value="4600">
											...
											<tbody>
												...
												<tr>
													<td class="name gt-position-relative"><span
														class="stamp-step-num">1</span>대표이사</td>
					...
					<div class="write_input hide" id="approvalEditorContent"
						...
						<div class="txt file">
							...
							<div id="new_compose_contents"
								class="se se-edit-mode se se se se se se se se se se se-classic-editor se-blur"
					...
					<div class="js-approval-input hide" id="approvalDbContent"
						...
						<script>
							$j(function() {
								ApprovalDocument._remittance = {};
								ApprovalDocument._remittance.request = [];
								ApprovalDocument._remittance.currentRequest = {};
							});
						</script>
					</div>
