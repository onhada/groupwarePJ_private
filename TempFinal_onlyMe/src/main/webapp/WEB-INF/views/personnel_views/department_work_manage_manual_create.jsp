								...
								<td data-v-6b9f430d="" class="setting-td"><div
										...
										<div data-v-6b9f430d="" class="el-select"
											...
											<div class="el-input is-disabled el-input--suffix">
												...
												<input type="text" disabled="disabled" readonly="readonly"
													autocomplete="off" placeholder="선택" class="el-input__inner">
												<!---->
									...
									<div data-v-6b9f430d="" class="d-flex align-items-center">
										<span data-v-6b9f430d="" class="title-span">생성 일수(시간)</span><input
											...
											placeholder="" min="0" max="60" class="hw-input"
											disabled="disabled" value="" style="width: 120px;"><span
											data-v-6b9f430d="" class="ml-10 mr-20">일</span>
										<button data-v-f8d3258e="" data-v-6b9f430d="" type="button"
											class="hw-button text">
											<!---->
